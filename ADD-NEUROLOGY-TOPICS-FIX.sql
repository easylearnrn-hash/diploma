-- ============================================
-- FIX: Insert Neurology topics
-- Run AFTER ADD-TOPIC-STATUS-COLUMN.sql has been applied
-- ============================================

-- Step 1: Ensure Neurology subject exists
...
-- Step 2: Insert all 17 Neurology topics
...
-- Step 3: Ensure test config exists for Neurology
...
-- ============================================
-- VERIFICATION — should show both subjects
-- ============================================
